...
const GenericTable9 = ({
  ...
  // Enhanced data source with better error handling and loading states
  ...
  }, [apiUrl, fetchDataParams, paginationPageSize, axiosConfig, handleError, onDataLoaded]);
